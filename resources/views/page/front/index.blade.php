...
@section('image','https://cmsecom2.idtest.work/storage/thumbnails/browser.png')
...
<div>
 ...
 Photos
    ...
    <div class="flex pt-10 space-x-5 mx-auto justify-center">
        <img src="https://cmsecom2.idtest.work/storage/thumbnails/browser.png" alt="logo" class="w-24 h-24 inline-block">
        <img src="https://cmsecom2.idtest.work/storage/thumbnails/browser.png" class="w-24 h-24">
    </div> <span class="mx-auto w-full text-center"><p
      class="
        mt-5
        sm:mt-10
        text-gray-400
