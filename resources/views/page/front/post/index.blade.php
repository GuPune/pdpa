    ...
    <div>
        <div>
            <div class="mx-auto text-center w-full md:w-1/2">
                <div id="samplePhoto" class="my-5"><div class="
                  ...
                  <div class="relative row-span-2 cursor-pointer  modal-open text-center">
                    ...
                    <img src="https://www.meditationphoto.com/images/approve.png" class="absolute bottom-4 right-4 w-10 h-10"></div> <div class="text-center">
