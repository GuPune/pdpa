...
function generateGuid() {
    ...
    function() {
        ...
        return '<!-- Button Drop Down -->\n<div class="form-group">\n  <label class="col-md-4 control-label" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-md-4" <%}else { %> "<%= inputsize %>"<%}%>>\n    <div class="input-group">\n      <input id="<%= id %>" name="<%= id %>" class="form-control" placeholder="<%= placeholder %>" type="text" <% if(required) {%> required <% } %> />\n      <div class="input-group-btn">\n        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">\n          <%= buttontext %>\n          <span class="caret"></span>\n        </button>\n        <ul class="dropdown-listmenu pull-right"><% _.each(buttonoptions, function(value) { %>\n          <li><a href="#"><%= value %></a></li><% }); %>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n'
...
if (!jQuery) throw new Error("Bootstrap requires jQuery"); + function(e) {
    ...
    r.prototype.toggle = function(t) {
        ...
        var u = e("[role=listmenu] li:not(.divider):visible a", i);
        if (!u.length) return;
    ...
    e.fn.dropdown = function(t) {
        ...
        e.stopPropagation()
    }).on("click.bs.dropdown.data-api", n, r.prototype.toggle).on("keydown.bs.dropdown.data-api", n + ", [role=listmenu]", r.prototype.keydown)
}(window.jQuery), + function(e) {
    var t = function(t, n) {
    ...
    t.DEFAULTS = {
        ...
        r.parent(".dropdown-listmenu").length && (r = r.closest("li.dropdown").addClass("active")), r.trigger("activate")
    };
    ...
    t.prototype.show = function() {
        var t = this.element,
            n = t.closest("ul:not(.dropdown-listmenu)"),
        ...
        function o() {
            i.removeClass("active").find("> .dropdown-listmenu > .active").removeClass("active"), t.addClass("active"), s ? (t[0].offsetWidth, t.addClass("in")) : t.removeClass("fade"), t.parent(".dropdown-listmenu") && t.closest("li.dropdown").addClass("active"), r && r()
        }
        var i = n.find("> .active"),
